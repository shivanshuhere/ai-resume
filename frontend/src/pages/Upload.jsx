    ...
    return (
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
                ...
                {error && (
                    <div className="mt-4 bg-red-50 border border-red-200 rounded-md p-4 flex items-start space-x-3">
                ...
                {success && (
                    <div className="mt-4 bg-green-50 border border-green-200 rounded-md p-4 flex items-start space-x-3">
